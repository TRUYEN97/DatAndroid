 ...
 * @author Admin
 */
public class SH_B_AUTO_MODE<V extends AbsModeViewFragment> extends AbsSaHinhMode<V> {

    public SH_B_AUTO_MODE(V hinhView, boolean isOnline) {
        super(hinhView, 24, 1080, MODEL_RANK_NAME.RANK_B, List.of("B01"), isOnline);
    }
